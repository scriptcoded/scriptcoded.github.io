...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.regexList = [
            ...
            { regex: new RegExp('([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+)', 'g'),                     css: 'value' },    // NUMBERSNUMBERS - double escape stuff because javascript
            { regex: new RegExp('\\(|\\)|\\]|\\[|\\}|\\{|\\,|(&lt;)|(&gt;)|=|\\/|\\+|\\-|\\*|(\\.\\.)|:', 'g'),  css: 'operators' } // stuff - double escape stuff because javascript
            ];
    }
